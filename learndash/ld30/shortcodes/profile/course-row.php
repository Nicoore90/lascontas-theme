 ...
 */
 ...
 add_shortcode('share_button', function() {
	?>
		<div>
			<a href="https://www.linkedin.com/profile/add?startTask=CERTIFICATION_NAME&name=Test%20Certificate&organizationId=81848638&issueYear=2023&amp;issueMonth=10&certUrl=https%3A%2F%2Fdocs.microsoft.com%2Fen-us%2Flearn%2Fcertifications%2Fd365-functional-consultant-sales&amp;certId=1234">
...
<div class="<?php echo esc_attr( $course_class ); ?>" id="<?php echo esc_attr( 'ld-course-list-item-' . $course_id ); ?>">
	...
	<div class="ld-item-list-item-preview">
		...
		<div class="ld-item-details">
			...
			$year = date('Y');
			$month = date('m');
			//var_dump($learndash_certificate_link);
			if ( ! empty( $learndash_certificate_link ) ) :
				...
				<div>
					<a href="https://www.linkedin.com/profile/add?startTask=CERTIFICATION_NAME&name=<?php echo get_the_title( $course_id );?>&organizationId=81848638&issueYear=<?php echo $year;?>&amp;issueMonth=<?php echo $month;?>">
						<!--<img id="linkedin_image" src="https://download.linkedin.com/desktop/add2profile/buttons/en_US.png" alt="LinkedIn Add to Profile button">-->
						<i class="fa-brands fa-linkedin"></i><p class="share_message">Compartir en LinkedIn</p>
					</a>
				</div>
			<?php endif; ?>
